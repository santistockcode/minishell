...
/*   Updated: 2026/02/04 19:45:46 by mnieto-m         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	parsing(t_shell *shell)
{
	...
	index = 0;
	shell->commands = NULL;
	if (parse_pipe_sequence(&shell->commands, shell->lexing->tokens, &index,
			shell) != SUCCESS)
	{
 ...
 */
int	parse_pipe_sequence(t_list **commands, t_list *tokens, int *index,
		t_shell *shell)
{
	t_command	*cmd;
	t_list		*new_node;
 ...
 */
int	parse_simple_command(t_command **cmd, t_list *tokens, int *index)
{
	t_token	*token;
